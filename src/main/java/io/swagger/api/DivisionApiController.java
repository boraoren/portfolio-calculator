...
public class DivisionApiController implements DivisionApi {
    ...
    public ResponseEntity<ResultResponse> division(@ApiParam(value = "first number",required=true) @PathVariable("number1") Double number1,@ApiParam(value = "second number",required=true) @PathVariable("number2") Double number2) {
