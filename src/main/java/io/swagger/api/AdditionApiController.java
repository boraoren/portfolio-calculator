...
@Controller
public class AdditionApiController implements AdditionApi {

    private static final Logger log = LoggerFactory.getLogger(AdditionApiController.class);
    ...
    public AdditionApiController(ObjectMapper objectMapper, HttpServletRequest request) {
        this.objectMapper = objectMapper;
        this.request = request;
    }

    public ResponseEntity<ResultResponse> addition(@ApiParam(value = "first number",required=true) @PathVariable("number1") Double number1,@ApiParam(value = "second number",required=true) @PathVariable("number2") Double number2) {
