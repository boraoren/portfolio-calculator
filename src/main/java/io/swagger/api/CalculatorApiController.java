...
public class CalculatorApiController implements CalculatorApi {
    ...
    public ResponseEntity<ResultResponse> sumOfFourOperations(@ApiParam(value = "first number",required=true) @PathVariable("number1") Double number1,@ApiParam(value = "second number",required=true) @PathVariable("number2") Double number2) {
